...
import { loginRecruiter } from "../../actions/authActions";
...
class Login extends Component{
    ...
    onSubmit = e => {
        ...
        this.props.loginRecruiter(userData);
    }
    render(){
          ...
          <>
            <div className="formCont">
              ...
              <div className="formright">
                ...
                <h2 style={{"textAlign":"center","color":"white","paddingBottom":"20px","fontSize":"25px"}}>Recruiter Login</h2>
                ...
                <div className="text-center no_account">Don't have an account? <Link to="/registerRecruiter">Register</Link></div>
            ...
            <form className="form-container" onSubmit={this.onSubmit}>
                ...
                <div className="text-center">Don't have an account? <Link to="/registerRecruiter">Register</Link></div>
