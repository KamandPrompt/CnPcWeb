...
class viewResponsesRecruiter extends Component {
  constructor(props) {
    super(props);
    this.state = {
      DataisLoaded: false,
        ...
        const columns = [
          ...
          },
          {
            ...
            renderCell: (params) => {
              return (
                <>
                  <Link to={"/viewResponsesRecruiter?fid=" + params.row.FID+"&sid="+params.row.SID} target="_blank">
...
viewResponsesRecruiter.propTypes = {
...
export default connect(mapStateToProps, { logoutUser })(viewResponsesRecruiter);
